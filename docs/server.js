...
const createNext = ssrContext => opts => {
  ...
  if (opts.path.indexOf('http') !== 0 && ('/rei-cedar-proving-grounds/' !== '/' && opts.path.indexOf('/rei-cedar-proving-grounds/') !== 0)) {
    opts.path = urlJoin('/rei-cedar-proving-grounds/', opts.path)
  }
  // Avoid loop redirect
